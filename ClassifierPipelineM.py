...
df2 = pd.read_csv('data/emotion_69k_preprocess.csv')

X_train , X_test , y_train , y_test = train_test_split(df2['empathetic_dialogues'],
                                                       df['emotion'],
                                                       test_size = 0.2,
                                                       random_state = 2)
...
model.save('models/EmDetModel_33Class2_40Epoch_Acc')
